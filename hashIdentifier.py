...
def WhirlpoolHMAC(hash):
    ...
    if len(hash)==len(hs) and hash.isdigit()==False and hash.isalpha()==False and hash.isalnum()==True:
        idents.append("122080")

idents=[]
h = ""
operation = "Hash identification"

def launchAttack(file_name):
    ...
    filw.write(("Identification result for hash\n"+h+"\n"))
    filw.write("========================================\n")
    if len(idents)==0:
        filw.write("Not Found\n")
    elif len(idents)>2:
        idents.sort()
        filw.write("Possible Hashes:\n")
        filw.write("[+]"+str(algorithms[idents[0]])+"\n") #this
        filw.write("[+]"+str(algorithms[idents[1]])+"\n") #this
        filw.write("========================================\n")
        filw.write("Least possible hashes:\n");
        for a in range(int(len(idents))-2):
            filw.write("[+] "+str(algorithms[idents[a+2]])+"\n") #this
    else:
        idents.sort()
        filw.write("Possible hashes:\n") #this
        for a in range(len(idents)):
            filw.write("[+] "+str(algorithms[idents[a]])+"\n")
